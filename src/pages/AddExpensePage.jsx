...
//                 >
//                   <div>
//                     <p className="font-bold">{e.title || e.expenseTitle}</p>
//                     <p className="text-sm text-gray-600">
//                       ₹{e.amount} | Budget: ₹{e.budget} | {e.date}{' '}
//                       | {e.category || e.category_names?.join(', ')}
//                     </p>
//                     {e.desc && (
//                       <p className="text-xs text-gray-500">Desc: {e.desc}</p>
//                     )}
//                   </div>
